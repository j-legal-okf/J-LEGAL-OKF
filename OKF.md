このプロジェクトの知識バンドル（Open Knowledge Format v0.2）は [`./okf/`](./okf/) にあります。

- 概要・目的・公開範囲 → [`okf/project.md`](./okf/project.md)
- 索引（機械生成） → [`okf/index.md`](./okf/index.md)

作業を始める前に `OKF.md` と `okf/project.md` を読んでください。

このバンドルは、公開コアの目的・スコープ境界・責任範囲を要約する導線です。
進捗・タスク・実行ログの正本ではありません。
[規範プロファイル](docs/jlegal-okf-profile-0.2.0-draft.md)、[利用手順](README.md)、
